...
public class XPathParser {
   ...
   * 但是，如果每个应用启动都从网络加载该 DTD 文件，势必在弱网络下体验非常差，甚至说应用部署在无网络的环境下，还会导致下载不下来，
   * 那么就会出现 XML 校验失败的情况。所以，在实际场景下，MyBatis 自定义了 EntityResolver 的实现，
   ...
   * 具体如何实现可以看 PropertyParser#parse(String string, Properties variables) 方法
   */
  ...
  public String evalString(Object root, String expression) {
    ...
    // <2> 基于 variables 替换动态值，如果 result 为动态值 (这就是 MyBatis 如何替换掉 XML 中的动态值实现的方式。)
